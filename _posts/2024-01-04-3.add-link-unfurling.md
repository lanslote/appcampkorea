...
> * <img src="../../assets/new-adventure/arrow-this-lab.png" style="height: 30pt; margin-bottom: -10pt;" /> [**Lab 3 - Add link unfurling**](../03-add-link-unfurling/) 이 랩에서는 사용자가 대화에 URL을 포함할 때 사용자 정의 요약을 제공하는 링크 언퍼링 기능을 사용하는 방법을 배우게 됩니다.
...
{: .note }
> 이 실습은 [실습 1](../01-create-app/) [과 2](../02-integrate-web-service/)에서 만든 솔루션을 활용합니다. 다음 단계로 넘어가기 전에 두 실습을 모두 수행해 주십시오.
...
이 실습을 완료한 후에는 이 학습 경로의 다음 실습인 [Lab 4 - Action message extensions with Open AI](../04-add-ai/)으로 계속 진행할 수 있습니다.
