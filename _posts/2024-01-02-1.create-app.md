...
> #### 실습 계획 
> 
> * <img src="../assets/new-adventure/arrow-this-lab.png" style="height: 30pt; margin-bottom: -10pt;" /> [**Lab 1 - Create your first app with Teams Toolkit**](../01-create-app/) 이 한국어 랩에서는 Teams Toolkit을 설정하고 Teams 메시지 확장을 만드는 방법을 알아보겠습니다.
...
> * [**Lab 6 - Run the app in Outlook**](../06-run-in-outlook/) 이 랩에서는 Microsoft Outlook에서 Northwind Suppliers 애플리케이션을 실행합니다.
{: .block-tip }
